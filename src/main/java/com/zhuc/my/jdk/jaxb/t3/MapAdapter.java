...
public class MapAdapter extends
		XmlAdapter<MapElements[], Map<String, AccountBean>> {
	@Override
	public MapElements[] marshal(Map<String, AccountBean> arg0)
			throws Exception {
	...
	public Map<String, AccountBean> unmarshal(MapElements[] arg0)
			throws Exception {
