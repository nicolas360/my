 ...
 * @createTime 2012-7-27 下午04:11:09
 * @version 1.0
 * @since 1.0
 * @description WebSocketHelper.java
 * 
 */
public class WebSocketHelper {
	...
	public boolean supportWebSocket(HttpRequest req) {
		return (HttpHeaders.Values.UPGRADE.equalsIgnoreCase(req.getHeader(HttpHeaders.Names.CONNECTION)) && HttpHeaders.Values.WEBSOCKET
