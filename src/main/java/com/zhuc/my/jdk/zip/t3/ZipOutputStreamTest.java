package com.zhuc.my.jdk.zip.t3;
...
public class ZipOutputStreamTest {
	...
	public static void test1() throws IOException {
		ZipOutputStream zos = new ZipOutputStream(new FileOutputStream("E:\\学习\\地图\\高德\\testZip.zip"));
		...
		InputStream is = new FileInputStream("E:\\学习\\地图\\高德\\t1.jsp");
		int len = 0;
		while ((len = is.read()) != -1)
			zos.write(len);
		is.close();
	...
	public static void test2() throws IOException {
		File inFile = new File("E:\\学习\\地图\\高德");
		ZipOutputStream zos = new ZipOutputStream(new FileOutputStream("E:\\学习\\地图\\高德\\test.zip"));
